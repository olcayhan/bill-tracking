                ...
                <table className='table'>
                    <tbody>
                        ...
                        <tr>
                            <td>Sifre</td>
                            <td>:</td>
                            <td>{isVisible ? "*".repeat(student?.password.length) : student?.password}
                                <span className='ms-2 fs-5' onClick={() => { setVisible(!isVisible) }}> {isVisible ? <BsEyeSlashFill /> : <BsEyeFill />}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                {
                                    student ? student.courses.map((item, key) => {
