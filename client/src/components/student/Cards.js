...
export default function Cards() {
    ...
    return (
        <div className='row row-cols-3 justify-content-center'>
            ...
            <button className='cardBackground col' onClick={() => { setStudentUnpaid(true) }} style={{ backgroundColor: "#D0B8A8" }}>
                <GoAlert size={70} />
                <br />
                Ödenmeyen
            </button>
            <button className='cardBackground col' onClick={() => { setStudentAnnounces(true) }} style={{ backgroundColor: "#FFFFD0" }}>
